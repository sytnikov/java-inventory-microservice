...
//import sytnikov.dev.inventory_microservice.application.stock.StockCreateDto;
//
...
//        // need to check if we have the same supplier-product pair. if so, throw an error with the hint to update an existing stock
...
//    public ResponseEntity<Stock> getStocksByProductId(@PathVariable String productBarcode) {
//        Stock stocksByProducts = _stockService.getStockByProductBarcode(productBarcode);
